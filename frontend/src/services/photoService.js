...
const like = async(id, token) => {
    ...
    try{
        const res = await fetch(api + "/photo/like/" + id, config).then((res) => res.json()).catch((error) => error);
...
const comment = async(data, id, token) => {
    ...
    try{
        const res = await fetch(api + "/photo/comment/" + id, config).then((res) => res.json()).catch((error) => error);
...
const searchPhotos = async (query, token) => {
    ...
    try{
        const res = await fetch(api + "/photo/search?q=" + query, config).then((res) => res.json()).catch((error) => error);
        console.log(res)
        return res;
